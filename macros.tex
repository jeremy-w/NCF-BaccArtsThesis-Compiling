...
\newcommand{\CPS}[1][short]{\ifthenelse{\equal {#1}{short}}{%then is short - the default
         \spacedlowsmallcaps{\abbrev{CPS}}\xspace%this suggests all \abbrev should be in small caps...
     }{%else is long
...
\newcommand{\GHC}[1][short]{\ifthenelse{\equal {#1}{short}}{%then is short - the default
         \spacedlowsmallcaps{\abbrev{GHC}}\xspace%this suggests all \abbrev should be in small caps...
     }{%else is long
