...
\newcommand{\myLocation}{Sarasota, Florida\xspace}
...
\chapter*{#1}}
\newcommand{\fixmarks}{\input{misc/fixmarks}}

\newcommand{\acmheadspace}{\relax}%{\hspace{1em plus 2pt minus 1pt}}
\newcommand{\acmhead}[1]{\relax}%{\textit{#1}\acmheadspace}
\newcommand{\acmclass}[4]{\relax}%{\item #1 [\spacedlowsmallcaps{#2}]\ifthenelse{\equal{#3}{}}{\relax}{: #3\ifthenelse{\equal{#4}{}}{\relax}{\empause\textit{#4}}}}% example: \acmclass{D.3.1}{Programming Languages}{Language Classifications}{applicative languages; nonprocedural languages;}
...
\newcommand{\CPS}[1][short]{\ifthenelse{\equal {#1}{short}}{%then is short - the default
         \abbrev{CPS}\xspace%this suggests all \abbrev should be in small caps...
     }{%else is long
...
\newcommand{\GHC}[1][short]{\ifthenelse{\equal {#1}{short}}{%then is short - the default
         \abbrev{GHC}\xspace%this suggests all \abbrev should be in small caps...
     }{%else is long
         Glasgow Haskell compiler\xspace%
     }%end-if
}%end-def
