...
\begin{itemize}
\item \vocab{subject reduction}. Type persists unchanged through $\beta$-reduction.
\[
...
\]
This has the effect that, if \stmt{M}{(\sigma \to \sigma)}, then $(Y_{\sigma}\; M)$ and $(M\; (Y_{\sigma}\; M))$ are interconvertible. We call this type of conversion \vocab{typed $Y$-conversion}.
