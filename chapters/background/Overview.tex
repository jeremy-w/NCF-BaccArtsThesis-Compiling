...
\item[\nameref{background:compilers}] introduces compilers at a high level, including their architecture and associated theory, and concludes with a discussion of bootstrapping a compiler followed by a simple example.
\end{description}