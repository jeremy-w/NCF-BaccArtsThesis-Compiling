...
%     thesisHeader - sets document class, loads packages, configures stuff
%     thesisBody - includes the actual text of the document
% thesisHeader inputs thesisMacros, which contains generally useful 
% newcommands
\input{thesisHeader}
\input{thesisBody}
\end{document}
